...
box_image = pygame.image.load('D:/velozity/electricity/assets/room.jpg')
...
device_images = {
    name: (
        pygame.transform.scale(pygame.image.load(f'D:/velozity/electricity/assets/{name}.png'), size), 
        pygame.transform.scale(pygame.image.load(f'D:/velozity/electricity/assets/{name}'+"_on.png"), size)
    )
...
background = pygame.image.load('D:/velozity/electricity/assets/shadow.jpg')
background = pygame.transform.scale(background, (WIDTH, HEIGHT))
roof = pygame.image.load('D:/velozity/electricity/assets/roof.png')
